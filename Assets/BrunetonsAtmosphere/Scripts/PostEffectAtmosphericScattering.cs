...
{
    public class PostEffectAtmosphericScattering : MonoBehaviour
    {

        public Material m_atmospherePostEffect;
        ...
        void OnRenderImage(RenderTexture source, RenderTexture destination)
        {
            ...
            m_atmospherePostEffect.SetMatrix("_FrustumCorners", frustumCorners);

            CustomGraphicsBlit(source, destination, m_atmospherePostEffect, 0);
        }
