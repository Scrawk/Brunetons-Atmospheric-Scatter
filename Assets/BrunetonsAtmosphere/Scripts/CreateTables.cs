...
namespace BrunetonsAtmosphere
{
    ...
    public class CreateTables : MonoBehaviour
	{
        ...
        private readonly Vector4 BETA_R = new Vector4(5.8e-3f, 1.35e-2f, 3.31e-2f, 0.0f);
        private readonly Vector4 BETA_MSca = new Vector4(4e-3f, 4e-3f, 4e-3f, 0.0f);
        private readonly Vector4 BETA_MEx = new Vector4(4.44e-3f, 4.44e-3f, 4.44e-3f, 0.0f);

        //Asymmetry factor for the mie phase function
        //A higher number meands more light is scattered in the forward direction
        private const float MIE_G = 0.8f;
